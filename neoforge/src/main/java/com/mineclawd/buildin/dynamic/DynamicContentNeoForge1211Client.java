...
public final class DynamicContentNeoForge1211Client {
    private static boolean initialized;

    private DynamicContentNeoForge1211Client() {
    }
    ...
    public static synchronized void init(IEventBus modEventBus) {
        ...
        initialized = true;
        modEventBus.addListener(DynamicContentNeoForge1211Client::onModifyBakingResult);
    }
